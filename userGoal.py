...
hotelTemplateSlot = {
    ...
    "inform_remove_constrain": [HOTEL_SLOT_CITY, HOTEL_SLOT_PRICE],
...
flightTemplateSlot = {
    ...
    "inform_remove_constrain": [FLIGHT_SLOT_APORT, FLIGHT_SLOT_FLIGHT, FLIGHT_SLOT_PRICE, FLIGHT_SLOT_DPORT, FLIGHT_SLOT_DEPARTCITY, FLIGHT_SLOT_TAKEOFFTIME, \
                                FLIGHT_SLOT_ARRIVETIME, FLIGHT_SLOT_ARRIVECITY, FLIGHT_SLOT_FLIGHT, FLIGHT_SLOT_CABININFO],
...
trainTemplateSlot = {
    ...
    "inform_remove_constrain": [TRAIN_SLOT_TERMINALSTATION, TRAIN_SLOT_ORIGINSTATION, TRAIN_SLOT_PRICE, TRAIN_SLOT_SEATTYPE, TRAIN_SLOT_TRAINNO, TRAIN_SLOT_TRAINTYPE, \
                                TRAIN_SLOT_STARTTIME, TRAIN_SLOT_ARRIVALTIME],
