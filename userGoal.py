...
flightTemplateSlot = {
    ...
    "req_with_select" : [SLOT_INDEX, FLIGHT_SLOT_TAKEOFFTIME, FLIGHT_SLOT_FLIGHT, FLIGHT_SLOT_PRICE, FLIGHT_SLOT_ARRIVETIME, FLIGHT_SLOT_CABININFO],
    "select_with_slot" : [SLOT_INDEX, FLIGHT_SLOT_TAKEOFFTIME, FLIGHT_SLOT_FLIGHT, FLIGHT_SLOT_PRICE, FLIGHT_SLOT_ARRIVETIME, FLIGHT_SLOT_CABININFO],
    "imp_filter": [],
